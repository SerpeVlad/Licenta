...
def train_logistic_regression(data,output_path="C:\\Users\\serpe\\Desktop\\LICENTA\\Panda\\ClasificarePozitie\\Training\\Raports\\LR3"):
    ...
    for i in range(5):
        ...
        clf = logistic_regression(random_state=i)
